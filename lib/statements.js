...
export default {
  ...
  select: {
    ...
    UP: ['core:select-up', 'editor:select-to-beginning-of-previous-paragraph'],
    UP2: ['core:select-page-up', 'core:select-to-top'],
    DOWN: ['core:select-down', 'editor:select-to-beginning-of-next-paragraph'],
  ...
  delete: {
    ...
    RIGHT: 'core:delete',
    RIGHT2: ['editor:delete-to-end-of-word', 'editor:delete-to-end-of-subword'],
