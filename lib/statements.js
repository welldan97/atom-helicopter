...
export default function({ nuclideQuickOpen, advancedOpenFile }) {
  return {
    ...
    main: {
      ...
      IMPORT: 'core:paste', // import
      EXPORT: [
        'core:copy', // text copy(cb) this
      ],
      THIS: [
        'editor:duplicate-lines', // text copy(here) this
      ],
      //'api-docs:search-under-cursor', // enter!!
    ...
    select: {
      ...
      THIS: 'editor:select-line', // text select this or selection mark this
      ALL: 'core:select-all',
    },
    ...
    delete: {
      ...
      THIS: [
        'editor:delete-line', // text delete this
        // TODO: move cut from here should be move action
        'core:cut' /*, 'editor:toggle-line-comments'*/, // text move los cb
      ],
    },
    ...
    file: {
      ...
      IMPORT: [
        ...
        'application:new-file', // new TODO
        'pane:reopen-closed-item',
      ],

      EXPORT: [
        'core:save', // file copy(orig) this
        'tree-view:duplicate', // file copy(setup) this
        'core:save-as', // file copy(setup, v2) this
        'tree-view:rename',
        'nuclide-clipboard-path:copy-absolute-path', // file copyName(absolute,cb) this
      ...
      SETUP: ['fuzzy-finder:toggle-buffer-finder'],
      delete: {
        ...
        THIS: [
          'core:close', // file delete this
          'tree-view:remove',
        ], // file delete this orig
    ...
    panes: {
      ...
      THIS: 'hey-pane:toggle-focus-of-active-pane', //pane mark this
      delete: {
        LEFT: 'core:close',
        RIGHT: 'core:close',
        THIS: 'core:close',
    ...
    bookmarks: {
      ...
      RIGHT: 'bookmarks:jump-to-next-bookmark',
      UP: 'bookmarks:jump-to-previous-bookmark',
      LEFT: 'bookmarks:jump-to-previous-bookmark',
      THIS: 'bookmarks:toggle-bookmark', // bookmark mark this
      delete: {
